...
public class CustomDefStateListDrawableDemo extends View {
	private static String TAG = "LX";
	...
	public CustomDefStateListDrawableDemo(Context context) {
		super(context);
	...
	public CustomDefStateListDrawableDemo(Context context, AttributeSet attrs, int defStyle) {
	...
	public CustomDefStateListDrawableDemo(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		mContext = context;
		initStateListDrawable(); // 初始化图片资源
