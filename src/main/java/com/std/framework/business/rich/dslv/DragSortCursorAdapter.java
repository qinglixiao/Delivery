...
/**
 * Description : A subclass of {@link android.widget.CursorAdapter} that provides
 ...
 * to {@link com.systoon.toon.common.ui.view.dslv.DragSortListView#setAdapter(ListAdapter)} and, since
 * this class implements the {@link com.systoon.toon.common.ui.view.dslv.DragSortListView.DragSortListener}
 * interfaces, it is automatically set as the DragSortListener for
...
public abstract class DragSortCursorAdapter extends CursorAdapter implements DragSortListView.DragSortListener {
     ...
     *
     * @see com.systoon.toon.common.ui.view.dslv.DragSortListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see com.systoon.toon.common.ui.view.dslv.DragSortListView.RemoveListener#remove(int)
     */
    @Override
    ...
    /**
     * Does nothing. Just completes DragSortListener interfaces.
     */
    @Override
