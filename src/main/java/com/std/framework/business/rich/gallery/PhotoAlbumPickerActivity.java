...
import com.std.framework.business.rich.gallery.Components.PhotoPickerAlbumsCell;
import com.std.framework.business.rich.gallery.Components.PhotoPickerSearchCell;
...
public class PhotoAlbumPickerActivity extends BaseFragment
    ...
    private ArrayMap<Integer, MediaController.PhotoEntry> selectedPhotos = new ArrayMap<>();
    private ArrayMap<Integer, Integer> checkboxTag = new ArrayMap<>();
    ...
    public View createView(Context context) {
        ...
        // dropDown.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.album_arrow_drop_down,
        // 0);
