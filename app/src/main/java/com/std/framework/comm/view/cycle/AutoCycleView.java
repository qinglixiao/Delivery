package com.std.framework.comm.view.cycle;//package com.std.framework.comm.view.cycle;
//
...
//import com.std.framework.comm.view.cycle.CirclePageIndicator.IconPagerAdapter;
//
