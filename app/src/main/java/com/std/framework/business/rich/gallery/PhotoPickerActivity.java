...
import com.std.framework.business.rich.gallery.Actionbar.ActionBarMenuItem;
import com.std.framework.business.rich.gallery.Actionbar.BaseFragment;
import com.std.framework.business.rich.gallery.Components.BackupImageView;
import com.std.framework.business.rich.gallery.Components.PhotoPickerPhotoCell;
...
import static com.std.framework.business.rich.gallery.PhotoAlbumPickerActivity.DarkTheme;
...
public class PhotoPickerActivity extends BaseFragment
    ...
    private int type;
    private ArrayMap<Integer, MediaController.PhotoEntry> selectedPhotos;
    ...
    public PhotoPickerActivity(int type, int limitPickPhoto,
                               ...
                               ArrayMap<Integer, MediaController.PhotoEntry> selectedPhotos,
    ...
    public View createView(Context context) {
        ...
        cancel.setText(LocaleController.getString("Cancel",
                R.string.Cancel));
        ...
        if (selectedAlbum != null) {
            emptyView.setText(LocaleController.getString("NoPhotos",
                    R.string.NoPhotos));
        } else {
            if (type == 0) {
                emptyView.setText(
                        LocaleController.getString("NoRecentPhotos",
                                R.string.NoRecentPhotos));
            } else if (type == 1) {
                emptyView
                        .setText(LocaleController.getString("NoRecentGIFs",
                                R.string.NoRecentGIFs));
            }
        }
        ...
        if (cell != null) {
            if (selectedAlbum != null) {
                ...
                if (photoEntry.thumbPath != null) {
                    ...
                    cell.photoImage
                            .setImageResource(R.drawable.album_nophotos);
                }
            } else {
                ArrayList<MediaController.SearchImage> array;
                if (searchResult.isEmpty() && lastSearchString == null) {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (viewType == 0) {
                ...
                if (view == null) {
                    ...
                    view = li.inflate(R.layout.album_media_loading_layout,
                            viewGroup, false);
                }
