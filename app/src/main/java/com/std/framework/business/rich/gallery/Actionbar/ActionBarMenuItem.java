package com.std.framework.business.rich.gallery.Actionbar;
...
import com.std.framework.business.rich.gallery.Components.ActionBarPopupWindow;
import com.std.framework.business.rich.gallery.Theme;
...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setBackgroundResource(R.drawable.album_list_selector);
    ...
    public void toggleSubMenu() {
        ...
        if (popupWindow == null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                popupWindow.setAnimationStyle(R.style.AlbumPopupAnimation);
            }
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, R.drawable.album_search_carret);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            clearButton.setImageResource(R.drawable.album_close_white);
