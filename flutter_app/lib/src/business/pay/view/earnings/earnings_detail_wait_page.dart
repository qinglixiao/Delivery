...
class EarningsWaitListPage extends StatefulWidget {
  @override
  _EarningsWaitListPageState createState() => _EarningsWaitListPageState();
}

class _EarningsWaitListPageState extends State<EarningsWaitListPage>
  ...
  Widget build(BuildContext context) {
    ...
    return RootPageWidget(
        ...
        task: _viewModel.getEarningsStatusData(isFirst: true,status: "待结算"),
        body: StreamBuilder<EarningsBean>(
            ...
            builder: (BuildContext context,
              ...
              return PullToRefresh(
                ...
                onRefresh: () {
                  return _viewModel.getEarningsStatusData(isFirst: false,status: "待结算");
                },
              );
            }));
  }
