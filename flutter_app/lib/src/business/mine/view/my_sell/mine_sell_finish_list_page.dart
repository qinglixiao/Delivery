...
class SellFinishListPage extends StatefulWidget {
  @override
  _SellFinishListPageState createState() => _SellFinishListPageState();
}

class _SellFinishListPageState extends State<SellFinishListPage> with PageBridge, AutomaticKeepAliveClientMixin {
  ...
  void loadMore() {
    _viewModel.loadFinishList(isFirst: false, isRefresh: false);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return RootPageWidget(
        ...
        task: _viewModel.loadFinishList(isFirst: true,isRefresh: true),
        body: StreamBuilder<MineSellList>(
            ...
            builder:
              ...
              return PullToRefresh(
                ...
                onRefresh: () {
                  return _viewModel.loadFinishList(isFirst: false,isRefresh: true);
                },
              );
            }));
  }
