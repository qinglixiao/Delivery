...
class SellAllListPage extends StatefulWidget {
  @override
  _SellAllListPageState createState() => _SellAllListPageState();
}

class _SellAllListPageState extends State<SellAllListPage> with PageBridge, AutomaticKeepAliveClientMixin {
  ...
  void loadMore() {
    _viewModel.loadAllList(isFirst: false, isRefresh: false);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return RootPageWidget(
        ...
        task: _viewModel.loadAllList(isFirst: true,isRefresh: true),
        body: StreamBuilder<MineSellList>(
            stream: _viewModel.streamAllList,
            builder:
              ...
              return PullToRefresh(
                ...
                onRefresh: () {
                  return _viewModel.loadAllList(isFirst: false,isRefresh: true);
                },
              );
            }));
  }
