...
class WaitReceivingListPage extends StatefulWidget {
  @override
  _WaitReceivingListPageState createState() => _WaitReceivingListPageState();
}

class _WaitReceivingListPageState extends State<WaitReceivingListPage> with PageBridge, AutomaticKeepAliveClientMixin {
  ...
  void loadMore() {
    _viewModel.loadWaitReceivingList(isFirst: false, isRefresh: false);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return RootPageWidget(
        ...
        task: _viewModel.loadWaitReceivingList(isFirst: true,isRefresh: true),
        body: StreamBuilder<MineBuyList>(
            stream: _viewModel.streamWaitReceivingList,
            builder:
              ...
              return PullToRefresh(
                ...
                onRefresh: () {
                  return _viewModel.loadWaitReceivingList(isFirst: false,isRefresh: true);
                },
              );
            }));
  }
