(function ()
{
    ...
    function h(a, b)
    {
        try
        {
            if (Math.random() < .01)
            {
                ...
                c.push("ex=" + g(b));
                c.push("top=" + g(e.top === e ? 1 : 0));
                c.push("ts=" + new Date().getTime());
                c.push("rnd=" + Math.floor(2147483648 * Math.random()));
                (new Image).src = q + "//jserr.cnzz.com/log.php?" + c.join("&");
            }
        }
        catch (d) {}
        return!0
    ...
    var q = function ()
    {
        ...
        {
            var d, f = a[b];
            if (f.src && (d = /^(https?:)\/\/[\w\.\-]+\.cnzz\.com\//i.exec(f.src))) {
                return d[1];
            }
        }
        return window.location.protocol
    }(),
    l = document, e = window, g = encodeURIComponent, m = decodeURIComponent, x = unescape, z = q + "//c.cnzz.com/core.php",
    A = q + "//ca.cnzz.com";
    p.prototype =
    {
        Ca : function ()
        {
            try
            {
                this.ma(), this.ja(), this.ha(), this.U(), this.ya(), this.S(), this.Ba(), this.w(), this.wa(),
                this.va(), this.za(), this.o(), this.ua(), this.xa(), this.Aa(), this.sa(), this.qa(),
                this.ta(), this.Ga(), e[this.G] = e[this.G] || {}, this.ra("_cnzz_CV")
            }
            catch (a) {
                h(a, "i failed")
            }
        ...
        ja : function ()
        {
            for (var a = document.getElementsByTagName("script"), b = new RegExp("^(https:|http:)?//.+\\.cnzz\\.com/[a-z0-9_]+\\.php\\?.*id=" + this.c,
            "i"), c = a.length - 1;
            0 <= c;
            c--) {
                var d = a[c];
        ...
        qa : function ()
        {
            ...
            {
                var a = e._czc;
                if ("[object Array]" === {}.toString.call(a)) for (var b = 0;
                b < a.length;
                b++)
                {
                    var c = a[b];
        ...
        Ga : function ()
        {
            try
            {
                if ("undefined" === typeof e._cz_account || e._cz_account === this.c)
                {
                    ...
                    if ("[object Array]" === {}.toString.call(e._czc)) for (var a = e._czc, b = 0, c = a.length;
                    b < c;
                    b++) this.L(a[b]);
                    this.Ea()
                }
            ...
            try
            {
                if ("[object Array]" === {}.toString.call(a)) switch (a[0])
                {
                    ...
                    if (a[1])
                    {
                        ...
                        {
                            var b = a[2];
                            "http" !== b.substr(0, 4) && (b = q + "//" + e.location.host, "/" !== a[2].charAt(0) && (b += "/"),
                            b += a[2]);
                            this.a.g = b
                        }
                        this.s();
                    ...
                    case "_trackEvent":
                    var c = [];
                    a[1] && a[2] && (c.push(g(a[1])), c.push(g(a[2])), c.push(a[3] ? g(a[3]) : ""), a[4] = parseFloat(a[4]),
                    c.push(isNaN(a[4]) ? 0 : a[4]), c.push(a[5] ? g(a[5]) : ""), this.v = c.join("|"),
                    ...
                    if (3 <= a.length)
                    {
                        ...
                        var d = a[1], f = a[2], k = a[3] || 0;
                        a = 0;
                        for (var n in this.a.b) {
                            a++;
                        }
                        if (5 <= a) {
                            return!1;
                    ...
                    c = [];
                    a[1] && a[2] && (c.push(g(a[1])), c.push(g(a[2])), this.u = c.join("|"), this.s(),
                    delete this.u);
                    break;
                    case "_setUUid":
                    var w = a[1];
        ...
        ia : function ()
        {
            try
            {
                ...
                for (b in this.a.b)
                {
                    "p" === this.a.b[b].h ? this.a.b[b].h = 0 : "-1" !== this.a.b[b].h && a > this.a.b[b].h && delete this.a.b[b];
                }
                this.I()
            }
            catch (c) {
        ...
        ua : function ()
        {
            try
            {
                return this.a.B = e.navigator.systemLanguage || e.navigator.language, this.a.B = this.a.B.toLowerCase(),
                this.a.B
            }
            catch (a) {
                h(a, "gL failed")
        ...
        va : function ()
        {
            try
            {
                return this.a.C = this.i("rtime"), null === this.a.C && (this.a.C = 0), 0 < this.T() && 432E5 < (new Date).getTime() - this.T() && (this.a.C++,
                this.a.ea = (new Date).getTime()), this.a.C
            }
            catch (a) {
                h(a, "gRVT failed")
            }
        ...
        Z : function ()
        {
            try
            {
                ...
                else "none" !== this.a.l ? b.push("cnzz_eid=" + g(this.a.l)) : (d = Math.floor(2147483648 * Math.random()) + "-" + this.D + "-" + this.M(this.o()),
                b.push("cnzz_eid=" + g(d))), b.push("ntime=" + this.D), 0 < b.length ? (a += g(b.join("&")),
                a += "; expires=" + c.toUTCString(), a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString();
                l.cookie = a
            }
            catch (f) {
                h(f, "sS failed")
        ...
        na : function (a, b)
        {
            try
            {
                ...
                {
                    l.write(x("%3Cscript src='" + a + "' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"));
                }
            }
            catch (f) {
                h(f, "cAS failed")
        ...
        s : function ()
        {
            try
            {
                ...
                b.push("h=1");
                var c = b.join("&");
                "[object String]" === {}.toString.call(this.v) ? this.j([q + "//ei.cnzz.com/stat.htm?" + c]) : this.F || this.u ? this.j([A + "/stat.htm?" + c]) : (this.W && this.j([q + "//" + this.W + "/stat.htm?" + c]),
        ...
        j : function (a)
        {
            try
            {
                ...
                {
                    a[d] && (c = "cnzz_image_" + Math.floor(2147483648 * Math.random()), e[c] = new Image,
                    e[c].ka = c, e[c].onload = e[c].onerror = e[c].onabort = function ()
                    {
                        try {
