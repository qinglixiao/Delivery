...
/**
 * Description : ListView subclass that mediates drag and drop resorting of items.
...
public class DragSortListView extends ListView {
     ...
     * common_close_gray to the edge of the drop slot the floating View must be to initiate
     * the slide.
     */
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (useDefault) {
                ...
                int bgColor = a.getColor(R.styleable.DragSortListView_float_background_color,
                        Color.BLACK);
    ...
    /**
     * For each DragSortListView Listener interfaces implemented by
    ...
    private class AdapterWrapper extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                v.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
     ...
     * common_close_gray neighborhood of the old position. If the user moves an item too far
